...
(function () {
    ...
    function barChartOptions(data, options) {

        var scale = options.scale[0],
            steps = options.scale[1];
        ...
        return {
            ...
            plugins: {
                afterDraw: function afterDraw(chart) {
                    ...
                    // Position Y ticks aligned right and above the line
                    ...
                    Chart.helpers.each(yAxis.ticks, function (tick, index) {
                        ...
                        ctx.fillText(tick, xPos - xPadding, yPos + -3);
                        ctx.restore();
                    });

                    // Break X ticks and bold last line
                    ...
                    var xAxis = chart.scales['x-axis-0'];
                     Chart.helpers.each(xAxis.ticks, function(tick, index) {
                        ...
                        var yPos = xAxis.top + 12;
                        
                    ctx.save();
                    ctx.translate(xPos, yPos);
                    //					    ctx.rotate(itemToDraw.rotation);
                    //					    ctx.font = itemToDraw.major ? majorTickFont.font : tickFont.font;
                    //					    ctx.fillStyle = itemToDraw.major ? majorTickFontColor : tickFontColor;
                    //					    ctx.textBaseline = itemToDraw.textBaseline;
                    ctx.textAlign = 'center';
                                                
                         var label = tick;
                        
                    if (Chart.helpers.isArray(label)) {
...
if (typeof window !== "undefined") {
    window.ReportingCharts = ReportingCharts;
}

module.exports = ReportingCharts;
